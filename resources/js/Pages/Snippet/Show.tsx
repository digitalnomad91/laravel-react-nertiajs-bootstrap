                    ...
                    >
                        <div className="py-8 flex flex-wrap md:flex-nowrap">
                            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                                <span className="font-semibold title-font text-white">{snippet.category.name}</span>
                                ...
                                <div className="codeBlock">
                                    <pre className="bg-gray-100 p-1 rounded-md overflow-scroll h-32 overflow-hidden">
                                        <code className="text-sm font-mono code">
                                            {snippet.paid_item != true && <span>{snippet.content}</span>}
                                            {snippet.paid_item == true && <h3>Content Available To Subscribed Members Only!</h3>}
                                        </code>
                                    </pre>
                                </div>
